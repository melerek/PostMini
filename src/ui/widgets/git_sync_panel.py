...
A collapsible left panel for managing Git-based collaboration settings.
"""
...
class GitSyncPanel(QWidget):
    """Panel for Git sync configuration and management."""
    ...
    def _create_setup_tab(self) -> QWidget:
        ...
        browse_button.setProperty("class", "secondary")
    ...
    def _create_status_tab(self) -> QWidget:
        ...
        self.sync_status_label.setStyleSheet("font-size: 12px; font-weight: 600;")
        ...
        row1.addWidget(self.sync_to_fs_button)
        ...
        row2.addWidget(self.show_git_commands_button)
